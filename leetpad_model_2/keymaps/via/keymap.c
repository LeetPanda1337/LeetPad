...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER0] = LAYOUT_keymap(
        ...
        KC_AUDIO_MUTE,   KC_MPLY,   KC_F15,   KC_F17,   KC_NO,   KC_F18,   KC_F21),  // Knob button is in the key matrix because it's the only way to let VIA control it
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    ...
    return true;  // This function is the easiest way to remove knob debounce, when firmware is ignoring the first scroll in the counter direction
}
